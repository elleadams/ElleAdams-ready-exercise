...
knitr::read_chunk('processingcode2.R') # changed to copied version of processingcode.R
```
# Setup
...
```{r}
# convert 'sixty' to 60, convert '6' to 6ft -> 183cm, then make 'Height' numeric. changed from original to keep height rather than delete the whole row
d1 <- rawdata %>%
  dplyr::mutate(
    Height = as.character(Height),
    Height = dplyr::if_else(Height == "sixty", "60", Height),
    Height = as.numeric(Height),
    Height = dplyr::if_else(Height == 6, round(6 * 30.48, 0), Height)
  )
